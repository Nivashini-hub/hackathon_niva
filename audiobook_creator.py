...
with gr.Blocks() as demo:
    gr.Markdown("## 🤖 IBM Granite Chatbot with Audiobook Mode")
...
# -------------------------
with gr.Blocks(title="IBM Granite Chatbot — Audiobook & Audio Toolkit") as demo:
    gr.Markdown("# 🎧 IBM Granite Chatbot — Audiobook Mode (Hackathon Edition)")
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            clip_end = gr.Number(value=None, label="Clip end (sec) — leave empty for full reply")
            hum_freq = gr.Number(value=0, label="Background hum freq (Hz). 0→off")
